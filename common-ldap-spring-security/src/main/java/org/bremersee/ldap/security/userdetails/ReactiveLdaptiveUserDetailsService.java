...
import org.bremersee.ldap.reactive.ReactiveLdaptiveOperations;
...
@Slf4j
public class ReactiveLdaptiveUserDetailsService extends
    org.bremersee.ldap.security.userdetails.AbstractUserDetailsService implements
  ...
  public ReactiveLdaptiveUserDetailsService(
    ...
    super(
        userBaseDn, userFindOneFilter, userFindOneSearchScope, userAccountControlAttributeName,
        authorities,
