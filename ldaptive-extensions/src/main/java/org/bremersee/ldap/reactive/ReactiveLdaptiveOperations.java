...
public interface ReactiveLdaptiveOperations {
   ...
   * @return the mono
   */
  default <T> Mono<T> findOne(@NotNull SearchRequest searchRequest,
   ...
   * @return the flux
   */
  default <T> Flux<T> findAll(@NotNull SearchRequest searchRequest,
      @NotNull LdaptiveEntryMapper<T> entryMapper) {
   ...
   * @return the mono
   */
  default <T> Mono<Boolean> exists(@NotNull T domainObject,
      @NotNull LdaptiveEntryMapper<T> entryMapper) {
